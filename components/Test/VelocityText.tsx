...
export const VelocityText = () => {
  ...
  const xRaw = useTransform(scrollYProgress, [0, 1], [2200, -4000]);
  const x = useSpring(xRaw, { mass: 3, stiffness: 400, damping: 50 });

  return (
    <section
      ref={targetRef}
      className="h-[50vh] bg-transparent dark:text-white text-neutral-950"
    >
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        >
          ...
          customer-first service come together. Your finances, protected."
        </motion.p>
      </div>
    </section>
  );
