  ...
  return (
    <footer className="flex cursor-pointer items-center justify-between gap-2 py-6">
      ...
      <div className="flex flex-1 flex-col justify-center max-xl:hidden -mr-1">
        ...
        <p className="text-14 truncate font-normal text-gray-600 max-w-[125px]">
          {user.email}
        </p>
      </div>
      <button
        className="bg-blue-700 text-white px-6 py-2 rounded-xl hover:bg-blue-900 transition-all ease-in-out transform hover:translate-y-[-2px] shadow-lg inline-block -mr-2"
