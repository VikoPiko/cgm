...
const Page = () => {
  return (
    <div className="px-3 grid gap-3 grid-cols-12 mb-4 overflow-hidden">
      <div className="col-span-12 flex items-center justify-center rotate-2">
        {/* <HeroImage /> */}
      </div>
      <Hero />
      {/* Chase Style Divs with account sign up ideas*/}
      ...
      <div className="col-span-12 flex flex-col items-center text-center mt-32 mb-5 font-medium text-7xl text-black dark:text-white sm:flex-row sm:justify-center md:block">
        <h1>Why Choose Us?</h1>
        <h1 className="mt-4 sm:mt-5 sm:ml-4 font-medium text-6xl text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 md:block md:items-end">
