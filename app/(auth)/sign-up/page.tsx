...
const SignUp = () => {
  ...
  return (
    <>
      <section className="flex h-screen w-full items-center justify-center bg-gray-100 -mt-10">
        <div className="w-full max-w-[420px] p-6 bg-white shadow-md rounded-md">
